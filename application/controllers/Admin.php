...
// ✅ Wrap in dummy container to prevent <html>
    ...
    public function scholarship_applications() {
        ...
        $page_data['page_name'] = 'scholarship_applications';
        $page_data['page_title'] = 'Scholarship Applications';
        $page_data['applications'] = $this->db->order_by('created_at', 'desc')->get('scholarship_applications')->result_array();
        $this->load->view('backend/index', $page_data);
    }
}
