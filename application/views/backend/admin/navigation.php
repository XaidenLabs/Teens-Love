...
<div class="left-side-menu left-side-menu-detached">
    ...
    <ul class="metismenu side-nav side-nav-light">
        ...
        <li class="side-nav-item <?php if ($page_name == 'scholarship_applications') echo 'active'; ?>">
            <a href="<?php echo site_url('admin/scholarship_applications'); ?>" class="side-nav-link">
                <i class="dripicons-document-edit"></i>
                <span><?php echo get_phrase('Scholarships'); ?></span>
            </a>
        </li>
