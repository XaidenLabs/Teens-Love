  ...
  <div class="container">
    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link fw-bold text-nowrap text-primary" href="javascript:;" onclick="showAjaxModal('<?php echo site_url('scholarship/modal_form'); ?>', 'Scholarship Application', 'xl')">
